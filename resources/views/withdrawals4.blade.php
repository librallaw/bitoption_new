...
<html lang="en">
  <head>
    ...
    <title>Withdrawals - Block Chain Traders</title>
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">
								<h4 class="box-title">Withdrawals Transactions</h4>
							</div>
							<div class="box-body">
									...
									<table class="table no-margin table-hover">
										...
										@foreach($withdrawals as $withdrawal)
											...
											<tr>
												...
												<td>
													<time class="timeago" datetime="{{$withdrawal->created_at->diffForHumans()}}" title="{{$withdrawal->created_at->diffForHumans()}}">{{$withdrawal->created_at->diffForHumans()}}</time>
												</td>
