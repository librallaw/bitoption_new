...
<head>
    ...
    <title>Change Password - Bitoption</title>
                    ...
                    <div class="tradingview-widget-container">
                        ...
                        <div class="col-md-6">
                            ...
                            <form method="POST" class="form-horizontal withdrawal-form" id="withdrawal-form" data-parsley-validate="true">
                                Current Password:<br>
                                <input type="password" name="cup" class="form-control"><br>
                                New Password:<br>
                                <input type="password" name="nup" class="form-control"><br>
                                Confirm New Password:<br>
                                <input type="password" name="ccup"class="form-control"><br>
                                <hr>
                                <input type="submit" name="sub" class="btn btn-success" value="Change Password">
                            </form>
