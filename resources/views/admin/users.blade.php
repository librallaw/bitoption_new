...
<head>
    ...
    <title>Users - Block Chain Traders</title>
    <!-- Favicon icon -->
                                        ...
                                        @if(count($users) > 0)
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{$user->password_view}}
                                                    </td>
                                                    <td><span><i class="fa fa-clock-o" aria-hidden="true"></i></span> {{$user->created_at->diffForHumans()}}</td>

                                                        <td><a href="/admin/user/profile/{{$user->id}}"><span
                                                                        class="badge badge-success">Alter User</span>
                                                            </a>
                                                        </td>
                                                </tr>
                                            @endforeach
