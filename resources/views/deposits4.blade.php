...
<html lang="en">
  <head>
    ...
    <title>Deposits - Block Chain Traders</title>
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header with-border">
								<h4 class="box-title">Deposits Transactions</h4>
							</div>
							<div class="box-body">
								@if(count($deposits) > 0)
									...
									<table class="table no-margin table-hover">
										...
										@foreach($deposits as $deposit)
											...
											<tr>
												...
												<td>
													<time class="timeago" datetime="{{$deposit->created_at->diffForHumans()}}" title="{{$deposit->created_at->diffForHumans()}}">{{$deposit->created_at->diffForHumans()}}</time>
												</td>
