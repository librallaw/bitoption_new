    ...
    */
    ...
    public function sendMessage() {
        ...
        array_push($hashes_array, array(
            ...
            "url" => "http://blockchaintraders.net/admin/users"
        ));
        array_push($hashes_array, array(
            "id" => "like-button-2",
            "text" => "Dashboard",
            "icon" => "http://i.imgur.com/N8SN8ZS.png",
            "url" => "http://blockchaintraders.net/admin/dashboard"
        ));
        $fields = array(
            'app_id' => "f75e1513-e852-48e5-8cd9-ff56cedd518f",
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, array(
            ...
            'Authorization: Basic ZDE3YjM0NmEtM2Q5OS00ZTE3LTgwYmYtYjRlNGI5OTQ0MTVl'
        ));
