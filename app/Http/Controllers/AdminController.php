...
class AdminController extends Controller
{
    ...
    public function showAdminDashboard()
    {
        ...
        $data['total_deposit'] =  Transaction::where('type',1)->latest()->get()->sum('amount');
        $data['pending_deposit'] =  Transaction::where('status',2)->where('type',1)->latest()->get();
        $data['total_successfull_deposit'] =  Transaction::where('status',1)->where('type',1)->latest()->get();

        $data['total_withdrawal'] =  Transaction::where('type',0)->latest()->get()->sum('amount');
        $data['pending_withdrawal'] =  Transaction::where('status',2)->where('type',0)->latest()->get();
        $data['total_successfull_withdrawal'] =  Transaction::where('status',1)->where('type',0)->latest()->get();
    ...
    public function pendingDeposit()
    {
        ...
        $data['deposits'] =  Transaction::where('status',2)->where('type',1)->latest()->get();
    ...
    public function pendingWithdrawal()
    {
        ...
        $data['withdrawals'] =  Transaction::where('status',2)->where('type',0)->latest()->get();
    ...
    {
             //Mail::to(strtolower($mail)->send(new WelcomeEmail()));


        $to = $mail;
        $from = 'noreplyblockchaintraders.net';
        $fromName = 'Block Chain Traders';

        $subject = "Welcome to Block Chain Traders";
...
<html style="width:100%;font-family:lato, \'helvetica neue\', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;">
 <head> 
  ...
  <title>New email template 2019-10-28</title> 
  <!--[if (mso 16)]>
    <style type="text/css">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                 <tr style="border-collapse:collapse;"> 
                  <td width="580" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:25px;padding-bottom:25px;"><img src="https://ffglli.stripocdn.email/content/guids/CABINET_3df254a10a99df5e44cb27b842c2c69e/images/7331519201751184.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="40"></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
